...
type BlogQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly date: string | null, readonly id: string | null, readonly title: string | null, readonly tags: ReadonlyArray<string | null> | null } | null } }> } };

type SeoQueryVariables = Exact<{ [key: string]: never; }>;


type SeoQuery = { readonly site: { readonly siteMetadata: { readonly defaultTitle: string | null, readonly defaultDescription: string | null, readonly defaultImage: string | null, readonly siteUrl: string | null } | null } | null, readonly siteImage: { readonly childImageSharp: { readonly fluid: { readonly src: string } | null } | null } | null };
...
type SingleBlogQuery = { readonly markdownRemark: { readonly html: string | null, readonly frontmatter: { readonly date: string | null, readonly id: string | null, readonly title: string | null, readonly tags: ReadonlyArray<string | null> | null } | null } | null };
